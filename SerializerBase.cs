...
namespace JKFlow.Core
{
    public class SerializerBase
    {
        ...
        public virtual void WriteData(string Name, float Data) { }
        /// <summary>
        ...
        public virtual float ReadAsFloat(string Name) { return 0; }
    ...
    public class SerializerXML : SerializerBase
    {
        ...
        public override void WriteData(string Name, float Data)
        {
            m_Writer.WriteAttributeString(Name, Data.ToString());
        }
        ...
        public override float ReadAsFloat(string Name)
        {
            if (!m_Reader.MoveToAttribute(Name)) return 0;
            string _text = m_Reader.ReadContentAsString();
            float _tmp = Convert.ToSingle(_text);
            return Convert.ToSingle(_text);
        }
